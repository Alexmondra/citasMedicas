...
<body>
    ...
    <main class="auth">
        ...
        <form class="auth-form" method="post" autocomplete="off"
            action="<?php echo BASE_URL ?>login/validarCredenciales">
            <!-- .form-group -->
            <?php error_reporting(0);?>
            <div class="form-group">
                <div class="form-label-group">
                    <input type="text" id="txtUsuario" name="txtUsuario" class="form-control" placeholder="Username"
                        autofocus="" value="<?php echo $_REQUEST["txtUsuario"]?>"> <label
            ...
            <div class="form-group">
                <div class="form-label-group">
                    <input type="password" id="txtPassword" name="txtPassword" class="form-control"
                        placeholder="Password" value="<?php echo $_REQUEST["txtPassword"]?>"> <label
