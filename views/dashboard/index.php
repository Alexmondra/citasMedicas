...
<body>
                        ...
                        <ul class="menu">
                            ...
                            <li class="menu-item has-child">
                                ...
                                <ul class="menu">
                                    ...
                                    <li class="menu-item">
                                        <a href="<?php echo BASE_URL?>paciente/reprogramar"
                                            class="menu-link">REPROGRAMAR CITA</a>
                                    </li>
                                    <li class="menu-item">
                                        <a href="<?php echo BASE_URL?>paciente/resultados"
    ...
    <script src="<?php echo BASE_URL ?>views/dashboard/assets/vendor/easy-pie-chart/jquery.easypiechart.min.js">
    </script>
