      ...
      <header class="app-header app-header-dark">
        ...
        <div class="top-bar">
          ...
          <div class="top-bar-brand">
            ...
            <a href="index.html"> <img src="<?php echo BASE_URL?>public/img/logoazuloriginal.png" height="28">
                <defs>
          ...
          <div class="top-bar-list">
            ...
            <div class="top-bar-item top-bar-item-right px-0 d-none d-sm-flex">
              ...
              <div class="dropdown d-none d-md-flex">
                <button class="btn-account" type="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><span class="user-avatar user-avatar-md"><img src="<?php echo BASE_URL?>public/img/doctor_login.jpg" alt=""></span> <span class="account-summary pr-lg-4 d-none d-lg-block"><span class="account-name">Beni Arisandi</span> <span class="account-description">Marketing Manager</span></span></button> <!-- .dropdown-menu -->
            ...
            <nav id="stacked-menu" class="stacked-menu">
              ...
              <ul class="menu">
                ...
                <li class="menu-item has-active">
                  <a href="<?php echo BASE_URL?>cpanel" class="menu-link">
                ...
                <!-- .menu-item -->
                <li class="menu-item has-child">
                  <a href="#" class="menu-link"><span class="menu-icon oi oi-wrench"></span> <span class="menu-text">ADMICIONISTA</span></a> <!-- child menu -->
                  <ul class="menu">
                    <li class="menu-item">
                    ...
                    <li class="menu-item">
                      <a href="<?php echo BASE_URL?>admisionista/cancelacion" class="menu-link">CANCELACION</a>
                    </li> 
                    <li class="menu-item">
                      <a href="<?php echo BASE_URL?>admisionista/reprogramar" class="menu-link">REPROGRAMAR</a>
                    </li>
                    <li class="menu-item">
                      <a href="<?php echo BASE_URL?>admisionista/reporte" class="menu-link">REPORTE DE ATENCIONES</a>
                    </li> 
                    <!-- <li class="menu-item">
      ...
      <main class="app-main">
       ...
       <?php require_once $data["contenido"];?>
        <footer class="app-footer">
          ...
          <div class="copyright"> Copyright © 2023. grupo 7 </div>
        </footer><!-- /.app-footer -->
        <!-- /.wrapper -->
      </main><!-- /.app-main -->
    </div><!-- /.app -->
